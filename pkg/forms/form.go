...
//to hold data form and an Erros field to hold any validation errors for the form
...
//Impelment a Required method to check that a specificfields in the form data are
//present and not blank. If any fields fail this check, add the appropriate message
//to the form errors
...
//contains a maximum number of characters. If the check fails then add the appropriate
...
//matched one of a set specific permitted values. If the check fails
